IMAGE = squad-3-ad-data-science
PACKAGE = squad_3_ad_data_science
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ squad_3_ad_data_science <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf squad_3_ad_data_science.egg_info
