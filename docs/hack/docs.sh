...
sphinx-apidoc -f -e -o docs/source/apidoc/ squad_3_ad_data_science/
...
sed -i '0,/squad_3_ad_data_science/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i '0,/project/s//squad_3_ad_data_science/' docs/source/index.rst
# Generate html docs
make -C docs/ html
